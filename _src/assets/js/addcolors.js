...
function addFirstPalete() {
    ...
    rectangleColor.classList.remove('add__color__light-blue', 'add__color__light-red');
  
    for (let i = 0; i < tagColors.length; i++) {
        tagColors[i].classList.add('add__color__medium-green');
        tagColors[i].classList.remove('add__color__medium-blue', 'add__color__medium-red');
    }
   
    for (let i = 0; i < buttonsColor.length; i++) {
        buttonsColor[i].classList.add('add__color__dark-green');
        buttonsColor[i].classList.remove('.add__color__dark-blue', 'add__color__dark-red');
    }

    for (let i = 0; i < circleColor.length; i++) {
        circleColor[i].classList.add('add__border__light-green');
        circleColor[i].classList.remove('add__border__light-blue', 'add__border__light-red');
    }
};
...
function addSecondPalete() {
    ...
    rectangleColor.classList.remove('add__color__light-blue', 'add__color__light-green');

    for (let i = 0; i < tagColors.length; i++) {
        tagColors[i].classList.add('add__color__medium-red');
        tagColors[i].classList.remove('add__color__medium-blue', 'add__color__medium-green');
    }
    for (let i = 0; i < buttonsColor.length; i++) {
        buttonsColor[i].classList.add('add__color__dark-red');
        buttonsColor[i].classList.remove('.add__color__dark-blue', 'add__color__dark-green');
    }
    for (let i = 0; i < circleColor.length; i++) {
        circleColor[i].classList.add('add__border__light-red');
        circleColor[i].classList.remove('add__border__light-green', 'add__border__light-blue');
    }
};
...
function addThirdPalete() {
    ...
    rectangleColor.classList.remove('add__color__light-green', 'add__color__light-red');

    for (let i = 0; i < tagColors.length; i++) {
        tagColors[i].classList.add('add__color__medium-blue');
        tagColors[i].classList.remove('add__color__medium-green', 'add__color__medium-red');
    }
    for (let i = 0; i < buttonsColor.length; i++) {
        buttonsColor[i].classList.add('.add__color__dark-blue');
        buttonsColor[i].classList.remove('add__color__dark-green', 'add__color__dark-red');
    }
    for (let i = 0; i < circleColor.length; i++) {
        circleColor[i].classList.add('add__border__light-blue');
        circleColor[i].classList.remove('add__border__light-green', 'add__border__light-red');
    }
};
